    ...
    <section class="home-features">
      ...
      <div class="feature-row">
        <div class="feature-text">
          <h3>간단한 질문으로 나에게 최적화된 금융 상품을 추천 받으세요</h3>
          <p>고객님의 상황을 기억하여 딱 맞는 금융 상품을 추천해 드립니다. <br />
      ...
      <div class="feature-row reverse">
        <div class="feature-text">
          <h3>국민은행 금융 상품, 한눈에 확인하세요</h3>
          <p>RAG를 이용한 정확한 답변으로 안심하고 금융 상품 정보를 받아보세요.</p>
          <!-- <a href="#">이동 링크</a> -->
        </div>
        <div class="image-grid">
      ...
      <div class="feature-row">
        <div class="feature-text">
          <h3>늘 대기중인 AI 상담원</h3>
          <p>원하는 은행의 상품 정보를 바로 확인하고, 상담받아보세요. <br />
      ...
      <div class="feature-row reverse">
        <div class="feature-text">
          <h3>대출 약관에 관해 물어보세요</h3>
          <p>간단한 정보 입력으로 받을 수 있는 대출 상품을 손쉽게 확인하세요. <br />
            고객님의 조건에 맞는 다양한 대출 상품을 정리해드립니다.</p>
          <!-- <a href="#">이동 링크</a> -->
        </div>
        <div class="image-grid">
          <img src="@/assets/images/home/hand.jpg" alt="Feature 2" />
        </div>
      </div>
